...
const col12 = ['mx-3 grid h-[100dvh] grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-3'];

const col = ['h-[100dvh] bg-green-500/10 outline outline-1 outline-green-500/20'];
