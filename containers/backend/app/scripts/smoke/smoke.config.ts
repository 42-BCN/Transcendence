...
export const LOCKOUT_EMAIL =
  process.env.AUTH_LOCKOUT_EMAIL ?? "lockout.test@fakemail.com";
export const LOCKOUT_PASSWORD =
  process.env.AUTH_LOCKOUT_PASSWORD ?? "LockoutTest123!";
...
export const TEST_SIGNUP_PASSWORD =
  process.env.AUTH_TEST_SIGNUP_PASSWORD ?? "SmokeTest123!";
