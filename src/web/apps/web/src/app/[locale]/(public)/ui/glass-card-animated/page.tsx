...
export default function GlassCardAnimatedPage() {
  return (
    <div className="w-full h-screen bg-slate-950 flex items-center justify-center relative overflow-hidden">
      {/* Esferas de Colores Animadas (Glow Ambient) */}
      <div className="absolute top-1/4 left-1/3 w-[300px] h-[300px] bg-indigo-600 rounded-full filter blur-[80px] opacity-40 animate-pulse duration-[4s]" />
      <div className="absolute bottom-1/3 right-1/4 w-[350px] h-[350px] bg-fuchsia-600 rounded-full filter blur-[100px] opacity-30 animate-pulse duration-[6s] delay-1000" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] bg-cyan-400 rounded-full filter blur-[60px] opacity-25 animate-pulse duration-[5s] delay-500" />
